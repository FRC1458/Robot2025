...
public class FieldLayout {
    ...
    public static Translation2d[] offsets = {
		new Translation2d(Constants.Swerve.trackWidth/2 + 0.089, -0.18),//left bar, 
		new Translation2d(Constants.Swerve.trackWidth/2 + 0.089, 0.18),//right bar
		new Translation2d(Constants.Swerve.trackWidth/2 + 0.089,0),//center of reef
		new Translation2d(-Constants.Swerve.trackWidth/2 - 0.089, -0.16),//left CS
		new Translation2d(-Constants.Swerve.trackWidth/2 - 0.089,0),//center CS
		new Translation2d(-Constants.Swerve.trackWidth/2 - 0.089,0.16),//right CS
	};
