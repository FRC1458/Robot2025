...
public class TestAuto1 extends AutoStringAuto {
    public TestAuto1() {
        ...
        super("S 1 R 1 Elevator 3 CShoot " // Initial sequence: 3 seconds
                   ...
                   + "( CS 1 CIntake R 4 Elevator 4 CShoot)"); // Third iteration: 4 secondsa
    }
}