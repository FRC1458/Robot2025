...
public class RobotContainer25 {
    ...
    private Hang m_Hang;
    private TeleopActionExecutor m_TeleopActionExecutor = TeleopActionExecutor.getInstance();
    
    private Controller m_Controller = new Controller(xboxController, m_TeleopActionExecutor);
